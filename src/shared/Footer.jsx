...
import blogIcon from '../assets/icons-white/message-24.png';
    ...
    <div className="bg-black md:h-96 px-7">
      <div className="max-w-7xl mx-auto py-20 flex flex-col md:flex-row justify-between">
        ...
        <div className="md:w-2/5 my-3">
          ...
          A Focused Web Developer and Programmer 
          building Websites and Web Applications that ensure 
        ...
        <div className='my-3'>
          ...
          <div className='mt-5 flex gap-3'>
            <a href="https://www.linkedin.com/in/aryan-sharma-09bb93256/" className='ml-1'><img src={linkedinIcon} alt="" className='w-7 h-7'/></a>
            <a href="https://github.com/aryann-21/" className='ml-1'><img src={githubIcon} alt="" className='w-7 h-7'/></a>
            {/* <a href="" className='ml-1'><img src={twitterIcon} alt="" className='w-7 h-7'/></a> */}
            <a href="mailto:aryan21sharmaa@gmail.com" className='ml-1'><img src={blogIcon} alt="" className='w-7 h-7'/></a>
