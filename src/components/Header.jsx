    ...
    <div className="w-full relative z-[100]">
      <div className="md:flex items-center justify-between bg-white py-4 md:px-14 px-7 fixed top-0 left-0 right-0 shadow-sm">
        ...
        <div className="font-bold text-xl tracking-wide cursor-pointer flex items-center gap-1">
            <img src={profileImg} alt="" className="md:w-12 md:h-12 w-10 h-10 rounded-[25px]"/>
          <span className="text-primary hover:text-secondary md:ml-3 ml-2">ARYAN SHARMA</span>
        </div>
        {/* Menu icon */}
        <div
