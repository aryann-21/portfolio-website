        ...
        <div className='max-w-7xl mx-auto my-14 md:py-8 px-7' id='about'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start'>
                ...
                className='md:w-1/2 my-8'>
                    ...
                    <p className='mb-5'>I am a 3rd year B.Tech student at NIT Jalandhar, specializing in Computer Science and Engineering. A dedicated <strong>web developer</strong> and <strong>programmer</strong>, I am passionate about crafting dynamic and ensuring seamless functionality and experiences.</p>

                    {/* <p className='mb-5'>I'm a <strong>Web Developer</strong> and <strong>programmer</strong> building Websites and Web Applications that leads to the success of the overall product. Check out some of my work in the <strong>Projects</strong> section.</p> */}

                    <p className='mb-5'>Furthermore, I actively engage in <strong>competitive programming</strong>, continuously honing my problem-solving skills and algorithmic thinking.</p>
